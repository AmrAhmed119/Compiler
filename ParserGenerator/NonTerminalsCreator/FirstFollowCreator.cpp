...
FirstFollowCreator::FirstFollowCreator(std::map<std::string, std::shared_ptr<NonTerminal>> &nonTerminals)
{
    createFirst(nonTerminals);
    createFollow(nonTerminals);
}
